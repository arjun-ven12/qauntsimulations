...
2. Rift creates bounded execution Worlds and runs Playwright Journeys through the configured execution provider.
3. The delayed-response World can exercise the controlled duplicate-submission defect.
4. Rift collects evidence and invariant evaluations, then uses bounded controls and reproductions to support a Finding.
