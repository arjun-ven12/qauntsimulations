...
function application() {
  ...
  const service = new InvestigationService(repository, new DeterministicExperimentPlanService(), { start: () => undefined });
